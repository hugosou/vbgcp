function Xpred = lno_test_mrp(results,idtest,idtrain, Xtest)
...
trained_offset = results.fit.offsets;
...
% Launch fit
results2 = tensor_mrp(Xtest_mi,fit_param,fit_init);
test_factors = results.fit.CP;
test_factors{1,ndims(Xtest)} = results2.fit.CP{1,ndims(Xtest)};
